...
class RestExceptionHandler: ResponseEntityExceptionHandler() {
    ...
    private fun buildResponseEntity(errorResponse: ErrorResponse) : ResponseEntity<Object>{
        return ResponseEntity(errorResponse as Object, errorResponse.httpStatus)
    }
}